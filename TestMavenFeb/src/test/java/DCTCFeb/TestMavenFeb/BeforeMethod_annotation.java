...
public class BeforeMethod_annotation extends Hierarchy_of_annotations {
  WebDriver driver;
  
      @BeforeMethod//beforemethod and aftermethod gets executed after every test cases that means it get executed multiple times but beforetest and aftertest gets executed single time only 
